...
describe('States', () => {
  ...
  describe('GFState', () => {
    ...
    test.skip('Match key1 Level: 1 Value: 10', () => {
      gf.set(key1,10,1);
    ...
    test.skip('Match key1 Level: 0 Value: 20', () => {
      gf.set(key1,10,1);
      expect(gf.isMatched(key1)).toBe(true);
      expect(gf.getMatchValue(key1)).toBe(10);
      expect(gf.isMatched(key1)).toBe(true);
    ...
    test.skip('Match key1 Level: 2 Value: 30', () => {
      gf.set(key1,30,2);
      expect(gf.isMatched(key1)).toBe(true);
    ...
    test.skip('Match key2 Level: 3 Value: 100', () => {
      gf.set(key2,100,3);
